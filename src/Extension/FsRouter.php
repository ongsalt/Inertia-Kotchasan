 ...
 * MODULE_ROOT/{controller}/{method} or MODULE_ROOT/{group}/{controller}/{method}
 * Use index method when no method is provided. The same go for controller. 
 */
class FsRouter extends \Kotchasan\Router
{
    protected $rules = [
